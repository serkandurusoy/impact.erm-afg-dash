const SECTIONS = [
  {
    ...
    subTitles: [
      ...
      { index: 1, subTitle: 'Household Demographics' },
      { index: 2, subTitle: 'Additional Vulnerability Assessment' },
      { index: 3, subTitle: 'General Assessment' },
      { index: 4, subTitle: 'Financial & Asset Assessment' },
      { index: 5, subTitle: 'Food & Nutrition Assessment' },
      { index: 6, subTitle: 'Wash Assessment' },
      { index: 7, subTitle: 'Shelter & NFI Assessment' },
      { index: 8, subTitle: 'Beneficiaries’ Priorities' },
    ],
  },
  {
    title: 'MPC',
